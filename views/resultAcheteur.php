...
<div class="container">
        ...
        <div class = "articles col-md-6 mb-3">
            <div class = "article contact-article">
                    ...
                    <ul>
                        <?php foreach ($interetCreches as $interet): ?>
                            <li>
                                ...
                                <strong>Niveau :</strong> <?= htmlspecialchars($interet->getNiveau()); ?> <strong> le :</strong> <?php echo htmlspecialchars($interet->getDateColonneFormatFr()); ?>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php else: ?>
                ...
                <?php if ($interetTaille): ?>
                    <strong>Taille recherchée :</strong> <?= htmlspecialchars($interetTaille->getTaille()) ?> <br>
                <?php else: ?>
    ...
    <div class = "articles col-md-9">
     ...
     <div id="popupModifContact" class="modal" style="display: none;">
        <div class="modal-content form-group d-flex flex-column align-items-center">
            ...
            <h3>Ajouter une information sur un acheteur</h3>
